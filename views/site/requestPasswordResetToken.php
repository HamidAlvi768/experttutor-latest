                ...
                <div class="login-form-panel h-100 px-md-4 pt-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <p class="login-subtitle mb-4">Enter your email address and we will send you a link to reset your password.</p>    
                        </div>
                    </div>
                    ...
                    <?= $form->field($model, 'email')->textInput(['autofocus' => true, 'placeholder' => 'Enter your email address']) ?>

                    <div class="form-group">
                        <?= Html::submitButton('Send Reset Link', ['class' => 'btn btn-primary login-btn w-100']) ?>
                    </div>
